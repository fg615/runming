...
class Product(models.Model):
    ...
    type = models.CharField(verbose_name=u"种类",
                            ...
                            max_length=10)
    moq = models.IntegerField(verbose_name=u"最小起订量", default=1)
    packing = models.IntegerField(verbose_name=u"包装量", null=True, blank=True, default=1)
    unit = models.CharField(max_length=100, verbose_name=u"单位", default="pcs")
    list_price = models.DecimalField(max_digits=20, decimal_places=2, default="0.00", verbose_name=u"面价")
    net_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name=u"折后价")
    currency = models.CharField(max_length=10, choices=(("rmb", "人民币"), ("eur", "欧元"), ("usd", "美元")), default="eur",
                                verbose_name=u"币种")
    class Meta:
        verbose_name = u"产品"
...
class Price(models.Model):
    ...
    currency = models.CharField(max_length=10, choices=(("rmb", "人民币"), ("eur", "欧元"), ("usd", "美元")),
                                verbose_name=u"币种")
    # name = models.CharField(max_length=100, verbose_name=u"名称")
    type = models.CharField(verbose_name=u"价格种类", choices=(("list_price", "面价"), ("net", "折后价"), ("other", "其他")),
                            max_length=20)
...
class OrderItem(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    product = models.ForeignKey(Product, null=True, on_delete=models.DO_NOTHING, verbose_name=u"产品")
    unit_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name=u"单位价格")
    ...
    exchange_rate = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"汇率", default=1.0)
    # pay_date = models.DateField(verbose_name=u"付款日期", null=True, blank=True);
    order = models.ForeignKey(Order, null=True, on_delete=models.DO_NOTHING, verbose_name=u"关联订单")
...
class LogisticVendor(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=255, verbose_name=u"物流商名称")
    contact = models.TextField(null=True, blank=True, verbose_name=u"联系方式")
    telephone = models.CharField(null=True, blank=True, max_length=255, verbose_name=u"电话")
...
class Consignment(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    consignment_type = models.CharField(verbose_name=u"包裹类型", choices=(("vendor", "供应商发货"), ("customer", "客户发货")),
                                  default="customer", max_length=10)
    currency = models.CharField(max_length=10, choices=(("rmb", "人民币"), ("eur", "欧元"), ("usd", "美元")), default="rmb",
                                verbose_name=u"币种", blank=True)
    exchange_rate = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"汇率", default=1.0)
    sum_in_rmb = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"人民币总费用")
    weight = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"重量(KG)")
    shipment_date = models.DateField(verbose_name=u"发货日期", default = timezone.now)
    shipment_type = models.CharField(max_length=10, choices=(("air", "空运"), ("see", "海运"), ("road", "公路"), ("other", "其他")), default="other",
                                verbose_name=u"运输方式")
    logistic_vendor = models.ForeignKey(LogisticVendor, on_delete=models.DO_NOTHING, verbose_name=u"物流商")
    ...
    def __str__(self):
        return self.logistic_vendor.name

class OrderConsignment(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    order = models.ForeignKey(Order, on_delete=models.DO_NOTHING, verbose_name=u"订单")
    consignment = models.ForeignKey(Consignment, on_delete=models.DO_NOTHING, verbose_name=u"包裹")
    ...
    def __str__(self):
        return self.order.partner.name

class Inquery(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    order_type = models.CharField(verbose_name=u"询价类型", choices=(("vendor", "向供应商询价"), ("customer", "客户询价")),
                                  default="customer", max_length=10)
    currency = models.CharField(max_length=10, choices=(("rmb", "人民币"), ("eur", "欧元"), ("usd", "美元")), default="rmb",
                                verbose_name=u"币种")
    exchange_rate = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"汇率", default=1.0)
...
class InqueryItem(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    product = models.ForeignKey(Product, null=True, on_delete=models.DO_NOTHING, verbose_name=u"产品")
    unit_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name=u"单位价格")
    quantity = models.IntegerField(verbose_name=u"单位数量", default=1)
    ...
    exchange_rate = models.DecimalField(max_digits=20, decimal_places=2, verbose_name=u"汇率", default=1.0)
    # pay_date = models.DateField(verbose_name=u"付款日期", null=True, blank=True);
    inquery = models.ForeignKey(Inquery, null=True, on_delete=models.DO_NOTHING, verbose_name=u"询价")
