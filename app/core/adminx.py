...
from .models import Product, LogisticVendor, Consignment, OrderConsignment, Partner
...
class LogisticVendorInline(object):
    model = LogisticVendor
    extra = 0

class ConsignmentInline(object):
    model = Consignment
    extra = 0

class ConsignmentAdmin(object):
    list_display = ['consignment_type', 'currency', 'exchange_rate', 'weight', 'sum_in_rmb']
    search_fields = ['consignment_type', 'currency', 'exchange_rate', 'weight', 'sum_in_rmb']
    list_filter = ['consignment_type', 'currency', 'exchange_rate', 'weight', 'sum_in_rmb']



class LogisticVendorAdmin(object):
    list_display = ['name', 'contact', 'telephone']
    search_fields = ['name', 'contact', 'telephone']
    list_filter = ['name', 'contact', 'telephone']
...
xadmin.site.register(Consignment, ConsignmentAdmin)
xadmin.site.register(LogisticVendor, LogisticVendorAdmin)
